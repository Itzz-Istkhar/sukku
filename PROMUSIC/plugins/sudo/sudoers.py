...
async def sudoers_list(client, message: Message):
    if message.from_user.id not in SUDOERS:
        return await message.reply_text("ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴜᴛʜᴏʀɪsᴇᴅ ᴛᴏ sᴇᴇ ᴍʏ ᴍᴏᴅᴇʀᴀᴛᴏʀs.")
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴜᴛʜᴏʀɪsᴇᴅ ᴛᴏ sᴇᴇ ᴍʏ ᴍᴏᴅᴇʀᴀᴛᴏʀs , ɪᴛ ᴡɪʟʟ ʙᴇ ʙᴇᴛᴛᴇʀ ɪғ ʏᴏᴜ sᴛᴀʏ ᴏɴ ʏᴏᴜʀ ʟɪᴍɪᴛs.", show_alert=True)
    else:
