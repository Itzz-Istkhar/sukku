...
async def stats_global(client, message: Message, _):
    if message.from_user.id not in SUDOERS:
        return await message.reply_text("⛔ ᴏɴʟʏ ᴛʜᴇ sᴜᴘʀᴇᴍᴇ ᴄᴏᴍᴍᴀɴᴅᴇʀ ᴀɴᴅ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ.")
...
async def home_stats(client, CallbackQuery, _):
    ...
    if CallbackQuery.from_user.id not in SUDOERS:
        return await CallbackQuery.answer("⛔ ᴏɴʟʏ ᴛʜᴇ sᴜᴘʀᴇᴍᴇ ᴄᴏᴍᴍᴀɴᴅᴇʀ ᴀɴᴅ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ.", show_alert=True)
